...
namespace RealisticTrade
{
    ...
    class RealisticTradeSettings : ModSettings
    {
        ...
        {
            return Find.Storyteller.storytellerComps.OfType<StorytellerComp_RandomMain>().First().IncidentChanceFinal(IncidentDefOf.TraderCaravanArrival, Find.AnyPlayerHomeMap);
        }
